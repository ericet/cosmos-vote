<template>
  <div class="mx-auto mx-5">
    ...
    <div v-if="response.type" class="mx-auto max-w-2xl">
      <div id="alert-3" class="flex p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 mx-auto max-w-2xl" role="alert"
        ...
        <div class="ml-3 text-sm font-medium text-green-700 dark:text-green-800">
          ...
          <a :href='response.explorer+"/txs/"+response.message' target="_blank"
            class="font-semibold underline hover:text-green-800 dark:hover:text-green-900">{{ response.message }}</a>.
        </div>
        <button type="button"
          class="ml-auto -mx-1.5 -my-1.5 bg-green-100 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-200 dark:text-green-600 dark:hover:bg-green-300"
          data-dismiss-target="#alert-3" aria-label="Close" @click="close">
      ...
      <div id="alert-2" class="flex p-4 mb-4 bg-red-100 rounded-lg dark:bg-red-200" role="alert"
        ...
        <button type="button"
          ...
          data-dismiss-target="#alert-2" aria-label="Close" @click="close">
          <span class="sr-only">Close</span>
